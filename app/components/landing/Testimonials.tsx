      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-16">
          ...
          >
            ...
            >
              <ChevronLeft className="w-5 h-5 mr-2 text-gray-600 group-hover:text-green-600 transition-colors" />
            </button>
            <button
              onClick={nextSlide}
              className="w-12 h-12 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-50 hover:border-green-200 transition-all duration-200 group"
            ...
            >
              <ChevronRight className="w-5 h-5 mr-2 text-gray-600 group-hover:text-green-600 transition-colors" />
            </button>
          </motion.div>
        </div>
