...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: <Facebook className="w-5 h-5 mr-2" />, href: "#" },
    { icon: <Twitter className="w-5 h-5 mr-2" />, href: "#" },
    { icon: <Instagram className="w-5 h-5 mr-2" />, href: "#" },
    { icon: <Linkedin className="w-5 h-5 mr-2" />, href: "#" },
  ];

  return (
    <footer className="bg-white border-green-100">
